...
| ID      | Status  | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Spec / Link                                                                                                                                                                                                 |
| ------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OG-PR-1 | pending | **OpenGrimoire:** `git add` + commit all **intentional untracked** OGAN deliverables so the PR does not omit them — e.g. `docs/agent/PLAYWRIGHT_VIZ_HARNESS_SELECTORS.md`, `docs/archive/` (legacy viz prompt archive), `e2e/visualization-constellation-a11y.spec.ts`, `e2e/visualization-constellation-network-shape.spec.ts`, `e2e/visualization-mock-banner.spec.ts`, `src/lib/visualization/surveyVisualizationFetch.ts` (confirm `git status` is clean except deliberate ignores). | Ce-review report (this chat); OpenGrimoire `git status`                                                                                                                                                     |
| OG-PR-2 | pending | **OpenGrimoire:** After staging, run **`npm run verify`** and **`npm run test:e2e`** on the branch; keep logs / CI green before merge.                                                                                                                                                                                                                                                                                                                                                   | Ce-review gate; [DEPLOY_AND_VERIFY.md](../../OpenGrimoire/docs/engineering/DEPLOY_AND_VERIFY.md)                                                                                                            |
| OG-PR-3 | pending | **Optional:** Extend **`npm run test:e2e:a11y`** (or CI job) to run **`e2e/visualization-constellation-a11y.spec.ts`** together with **`e2e/sync-session-admin-a11y.spec.ts`** — `test:e2e:viz-a11y` already exists for targeted runs.                                                                                                                                                                                                                                                   | [package.json](../../OpenGrimoire/package.json)                                                                                                                                                             |
| OG-PR-4 | pending | **Process:** Before merge, run compound **`/ce-review`** on the OpenGrimoire PR (e.g. `mode:report-only base:origin/master` and optional `plan:docs/plans/OA_FR_2_SYSTEM2_DATA_VISUALIZATION.md`), or equivalent human review — **AN1** closure still pending formal waive / `split_done` after policy sign-off.                                                                                                                                                                         | [AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md](../../OpenGrimoire/docs/AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md); [CE_REVIEW_DEFERRAL.md](../../OpenGrimoire/docs/audit/evidence/og-system2-mcp-wave/CE_REVIEW_DEFERRAL.md) |
| OG-PR-5 | pending | **Optional / tech debt:** `ConstellationView` **`useEffect([showTestData])`** calls `updateVisualization()` without listing it in deps — reconcile with `exhaustive-deps` or document intentional omission if stable.                                                                                                                                                                                                                                                                    | [ConstellationView.tsx](../../OpenGrimoire/src/components/visualization/ConstellationView.tsx)                                                                                                              |
| OG-PR-6 | pending | **Optional:** **`NavigationDots`** is still **unmounted** on production pages — remove dead export, wire nav, or document as demo-only.                                                                                                                                                                                                                                                                                                                                                  | [NavigationDots.tsx](../../OpenGrimoire/src/components/DataVisualization/shared/NavigationDots.tsx)                                                                                                         |
